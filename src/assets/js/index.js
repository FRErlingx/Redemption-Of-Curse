...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "First beta the 28 october 2024.", "author": "Skyyteq" },
            { "message": "Amusez-vous, bon RP.", "author": "Skyyteq" },
            { "message": "Redemption Of Curse RP, Jujutsu Kaisen RP Français", "author": "Skyyteq" }
        ];
